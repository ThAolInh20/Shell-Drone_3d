export const demoShow = [
   ...
   *    - x1, x2: Giới hạn chiều ngang (0.0 đến 1.0), dùng chung với sweep-left/right
  ...
  { time: 0.5, type: 'cometsequence', pattern: 'sweep-left', count: 9, duration: 0.5, ratioX: 0.5, sectorId: 'center' },
  { time: 1.5, type: 'cometsequence', pattern: 'sweep-right', count: 9, duration: 0.5, ratioX: 0.5, sectorId: 'center' },
  ...
  // { time: 3.0, type: 'sequence', pattern: 'sweep-left', count: 10, duration: 2.0, sectorId: 'right', preset: 'falling-comets' },
